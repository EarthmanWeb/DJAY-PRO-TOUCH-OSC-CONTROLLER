-- Source control: harmony_reset_b
-- File: TEEE-EMMEDIA.tosc

-- CONFIG
local VALUE = 0.5
local SLIDER_NAME = 'slider_2_16'
local SOLO_BUTTON = 'toggle_2_20'
local SOLO_FEEDBACK = 'toggle_2_20_yellow_bg'
local MUTE_BUTTON = 'toggle_2_12'
local MUTE_FEEDBACK = 'toggle_2_12_red_bg'
