-- Source control: drums_reset_a
-- File: TEEE-EMMEDIA.tosc

-- CONFIG
local VALUE = 0.5
local SLIDER_NAME = 'slider_1_14'
local SOLO_BUTTON = 'toggle_1_19'
local SOLO_FEEDBACK = 'toggle_1_19_yellow_bg'
local MUTE_BUTTON = 'toggle_1_10'
local MUTE_FEEDBACK = 'toggle_1_10_red_bg'
