-- Source control: vocal_reset_b
-- File: TEEE-EMMEDIA.tosc

-- CONFIG
local VALUE = 0.5
local SLIDER_NAME = 'slider_2_17'
local SOLO_BUTTON = 'toggle_2_21'
local SOLO_FEEDBACK = 'toggle_2_21_yellow_bg'
local MUTE_BUTTON = 'toggle_2_13'
local MUTE_FEEDBACK = 'toggle_2_13_red_bg'
