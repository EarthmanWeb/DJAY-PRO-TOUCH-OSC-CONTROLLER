-- Source control: harmony_reset_a
-- File: TEEE-EMMEDIA.tosc

-- CONFIG
local VALUE = 0.5
local SLIDER_NAME = 'slider_1_16'
local SOLO_BUTTON = 'toggle_1_20'
local SOLO_FEEDBACK = 'toggle_1_20_yellow_bg'
local MUTE_BUTTON = 'toggle_1_12'
local MUTE_FEEDBACK = 'toggle_1_12_red_bg'
