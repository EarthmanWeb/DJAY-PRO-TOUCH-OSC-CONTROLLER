-- Source control: drums_reset_b
-- File: TEEE-EMMEDIA.tosc

-- CONFIG
local VALUE = 0.5
local SLIDER_NAME = 'slider_2_14'
local SOLO_BUTTON = 'toggle_2_19'
local SOLO_FEEDBACK = 'toggle_2_19_yellow_bg'
local MUTE_BUTTON = 'toggle_2_10'
local MUTE_FEEDBACK = 'toggle_2_10_red_bg'
